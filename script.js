const caixaPrincipal = document.querySelector( "caixa-principasl");
...
const perguntas = [
    ...
    };
    {
        ...
        alternativas: [
            {
                texto:"a inteligencia artifical pode substituir juizes!"
                afirmacao: "afirmacao"
            },
    };
    {
        ...
        {
            texto:para que ela ajude a encontrar informações relevantes para o trabalho e explique numa linguagem que facilite o entendimento.",
         "Utiliza uma ferramenta de busca na internet que utiliza IA"
             afirmacao: "afirmacao"
        ...
        function mostraAlternativas(){
            for(const alternativa of perguntaAtual.alternativas) {
              ...
              function respostaSelecionada(opcaoSelecionada){
                const afirmacaes = opcaoSelecionada. afirmacoes 
